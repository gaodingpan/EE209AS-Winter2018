# 1 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
# 1 "C:\\Users\\dingg\\ECLIPS~1\\EE209A~1\\Receive\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
# 27 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 28 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 29 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
# 1 "C:\\PROGRA~2\\Arduino/hardware/arduino/avr/cores/arduino/avr/interrupt.h" 1
# 30 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 31 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 32 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2

# 1 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_private.h" 1
# 31 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_private.h"
...
# 34 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2

static void nothing(void) {
}

static volatile voidFuncPtr intFunc[2] = {
# 62 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    nothing,
...
# 81 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    switch (interruptNum) {
# 140 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:

      (*(volatile uint8_t *)(0x69)) = ((*(volatile uint8_t *)(0x69)) & ~((1 << 0) | (1 << 1))) | (mode << 0);
      (*(volatile uint8_t *)((0x1D) + 0x20)) |= (1 << 0);
# 153 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 1:

      (*(volatile uint8_t *)(0x69)) = ((*(volatile uint8_t *)(0x69)) & ~((1 << 2) | (1 << 3))) | (mode << 2);
      (*(volatile uint8_t *)((0x1D) + 0x20)) |= (1 << 1);
# 168 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 2:
# 181 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
void detachInterrupt(uint8_t interruptNum) {
  if(interruptNum < 2) {
    ...
    switch (interruptNum) {
# 235 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:
    ...
    case 2:
# 269 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
# 309 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
void __vector_1 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_1 (void) { intFunc[0](); }
void __vector_2 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_2 (void) { intFunc[1](); }
