# 1 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c"
# 1 "C:\\Users\\dingg\\ECLIPS~1\\EE209A~1\\Receive\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c"
# 23 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c"
...
# 24 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c" 2
# 33 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c"
unsigned long pulseIn(uint8_t pin, uint8_t state, unsigned long timeout)
{
 ...
 unsigned long width = countPulseASM(( (volatile uint8_t *)( (__extension__({ uint16_t __addr16 = (uint16_t)((uint16_t)(port_to_input_PGM + (port))); uint16_t __result; __asm__ __volatile__ ( "lpm %A0, Z+" "\n\t" "lpm %B0, Z" "\n\t" : "=r" (__result), "=z" (__addr16) : "1" (__addr16) ); __result; }))) ), bit, stateMask, maxloops);
...
# 63 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_pulse.c"
unsigned long pulseInLong(uint8_t pin, uint8_t state, unsigned long timeout)
{
 ...
 while ((*( (volatile uint8_t *)( (__extension__({ uint16_t __addr16 = (uint16_t)((uint16_t)(port_to_input_PGM + (port))); uint16_t __result; __asm__ __volatile__ ( "lpm %A0, Z+" "\n\t" "lpm %B0, Z" "\n\t" : "=r" (__result), "=z" (__addr16) : "1" (__addr16) ); __result; }))) ) & bit) == stateMask) {
